...
void CMover::update()
{
    ...
    // De plus, Labyrinthe n'a aucune méthode garantie d'être appelée une et une seule fois par update
    // Donc on désigne arbitrairement le CMover d'ID 1 le rôle de mettre à jour l'attribut statique...
    // Ce qui signifie qu'on devra toujours avoir au moins un CMover en plus du joueur
